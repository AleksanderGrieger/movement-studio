/**
 * Movement Studio wordmark, stacked lockup (footer).
 * See LogoHorizontal for why this is inline SVG rather than an <img>.
 */
export function LogoStacked() {
  return (
    <svg className="w-full h-auto" aria-hidden focusable="false" viewBox="0 0 1133.9 794">
      {" "}
      <g>
        {" "}
        <g>
          ...
          <g>
            ...
            <g>
              ...
              <path
                className="fill-(--logo-2) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
                d="M715.5,652.7v1.4c0,1.8-1.1,2.9-3.1,2.9h-24.6v68.8c0,1.9-1.1,3.1-3.1,3.1h-2.8c-1.9,0-3.1-1.1-3.1-3.1v-68.8h-24.5c-1.9,0-3.1-1.1-3.1-2.9v-1.4c0-1.9,1.1-3.1,3.1-3.1h58c1.9,0,3.1,1.1,3.1,3.1Z"
              />{" "}
              <path
                className="fill-(--logo-2) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
                d="M740.3,699.9v-47.2c0-1.9,1.1-3.1,3.1-3.1h2.8c1.9,0,3.1,1.1,3.1,3.1v47.2c0,14.8,10.2,22.2,22.1,22.2s22-7.4,22-22.2v-47.2c0-1.9,1.1-3.1,3.1-3.1h2.8c1.9,0,3.1,1.1,3.1,3.1v47.2c0,19.9-14.3,30.2-30.9,30.2s-31-10.3-31-30.2Z"
              />{" "}
              <path
                className="fill-(--logo-2) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
                d="M836.8,725.9v-73.1c0-1.9,1.1-3.1,3.1-3.1h21.7c24.3,0,40.2,17.8,40.2,39.6s-15.9,39.6-40.2,39.6h-21.7c-1.9,0-3.1-1.1-3.1-3.1ZM861.6,721.6c18.7,0,31-14.5,31-32.3s-12.3-32.3-31-32.3h-15.9v64.5h15.9Z"
              />{" "}
              <path
                className="fill-(--logo-2) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
                d="M931.4,725.9v-73.1c0-1.9,1.1-3.1,3.1-3.1h2.8c1.9,0,3.1,1.1,3.1,3.1v73.1c0,1.9-1.1,3.1-3.1,3.1h-2.8c-1.9,0-3.1-1.1-3.1-3.1Z"
              />{" "}
              <path
                className="fill-(--logo-2) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
                d="M969.9,689.3c0-22.5,18.6-40.9,41.1-40.9s41.1,18.3,41.1,40.9-18.5,40.9-41.1,40.9-41.1-18.3-41.1-40.9ZM1043,689.3c0-18.5-14.5-32.8-32-32.8s-31.9,14.4-31.9,32.8,14.4,32.8,31.9,32.8,32-14.4,32-32.8Z"
              />{" "}
            </g>{" "}
            <path
              className="fill-(--logo-1) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
              d="M160.8,313.5h-80.3c0-65.5-.2-131.1-.2-196.6.4-5.2,2.2-21.5,15.2-35.1,16.6-17.5,38.9-17.2,44.6-17.1,5.3,0,28.5.4,44.9,19,10.6,12.1,12.9,25.6,13.5,31.3v132.7h14.7V115.2c.1-5.2,1.1-18.6,10.7-30.9,13.9-17.8,35.2-19.4,42.7-19.5,4.2,0,26.6-.2,42,17.8,11,12.8,12.2,27.3,12.3,32.3v198.7h-47.3V119.2c-.4-3.3-3.1-5.9-6.4-6.2-3.5-.3-6.7,2.2-7.4,5.7v195.2h-84.5c.1-16.5-.8-34.6-3.3-53.9-8.1-61.1-29.4-109.7-48.4-143.4-1.9-3.1-5.9-4.1-9-2.4-3.2,1.8-4.3,6-2.4,9.3,1.9,3.1,4.6,7.7,7.6,13.3,16,29.8,23,55.1,27.5,72.2,7.3,27.2,10.1,49.4,11.4,62,1.7,16.6,2,31,1.9,42.5Z"
            />{" "}
            <path
              className="fill-(--logo-3) transition-[fill] duration-(--dur-ui) ease-(--ease-swing)"
              d="M160.8,596.7h-80.3c0-65.5-.2-131.1-.2-196.6.4-5.2,2.2-21.5,15.2-35.1,16.6-17.5,38.9-17.2,44.6-17.1,5.3,0,28.5.4,44.9,19,10.6,12.1,12.9,25.6,13.5,31.3v132.7h14.7v-132.5c.1-5.2,1.1-18.6,10.7-30.9,13.9-17.8,35.2-19.4,42.7-19.5,4.2,0,26.6-.2,42,17.8,11,12.8,12.2,27.3,12.3,32.3v198.7h-47.3v-194.5c-.4-3.3-3.1-5.9-6.4-6.2-3.5-.3-6.7,2.2-7.4,5.7v195.2h-84.5c.1-16.5-.8-34.6-3.3-53.9-8.1-61.1-29.4-109.7-48.4-143.4-1.9-3.1-5.9-4.1-9-2.4-3.2,1.8-4.3,6-2.4,9.3,1.9,3.1,4.6,7.7,7.6,13.3,16,29.8,23,55.1,27.5,72.2,7.3,27.2,10.1,49.4,11.4,62,1.7,16.6,2,31,1.9,42.5Z"
            />{" "}
          </g>{" "}
        </g>{" "}
      </g>{" "}
